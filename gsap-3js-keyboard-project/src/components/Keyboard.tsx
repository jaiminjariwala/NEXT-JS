...
export function Model(props: React.ComponentProps<'group'>) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      />
      <instancedMesh
        args={[nodes['2U_Wires'].geometry, materials.Gold, nodes['2U_Wires'].count]}
        castShadow
        receiveShadow
      ...
      />
      <instancedMesh
        args={[nodes.Stab_Housing_Instances.geometry, materials.Stem, nodes.Stab_Housing_Instances.count]}
        castShadow
        receiveShadow
